...
class CASTAXONOMYDATA_EXPORT TransferredAnnotation
{
public:
...
class CASTAXONOMYDATA_EXPORT Cell
{
public:
    QString cell_id;
    float confidence;
...
class CASTAXONOMYDATA_EXPORT Annotation
{
public:
...
class CASTAXONOMYDATA_EXPORT Taxonomy
{
public:
